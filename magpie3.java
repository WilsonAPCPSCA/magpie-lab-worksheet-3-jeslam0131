package magpie3;
	...
	public class magpie3
	{
		...
		public String getResponse(String statement)
		{
					...
					|| findKeyword(statement, "brother") >= 0)
			{
			...
			else if ( findKeyword(statement,"dogs")>=0 || findKeyword(statement,"cats")>=0){
				...
				response  = "Interesting, what is your favorite type of food";
				
			}
			else if ( findKeyword(statement,"weather")>=0){
				response  = "It will be chilly outside";
			}
			else if (findKeyword(statement,"sleep")>=0){
				response  = "I love to sleep";
			}
			else
			{
